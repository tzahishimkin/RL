# -*- coding: utf-8 -*-
"""
To review according to the following source:
...
#implement a multi-layer neural network that predicts the next observation, reward, and done state from a current state and action.
